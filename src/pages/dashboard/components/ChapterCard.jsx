...
const ChapterCard = ({ chapter, onViewDetails, className = "" }) => {
  ...
  return (
    <div
      className={`bg-card border border-border rounded-lg shadow-warm hover:shadow-warm-lg transition-narrative ${className}`}
    >
      {/* Chapter Header */}
      <div className="p-6 border-b border-border">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center space-x-3">
            <div
              className={`w-10 h-10 rounded-lg bg-muted flex items-center justify-center ${getChapterColor(
                chapter?.type
              )}`}
            >
