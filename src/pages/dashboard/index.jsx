...
const Dashboard = () => {
  ...
  const monthlyNarrativeSummary = {
    ...
    insight:
      "Small consistent actions create powerful financial momentum. Your disciplined approach this month is building the foundation for long-term wealth.",
    visualization: {
  ...
  const financialChapters = [
    ...
    },
    {
      ...
      progress: 72,
      narrative: `Right now, you're in the momentum phase of your financial story. Your disciplined approach is paying dividends, with consistent savings and smart spending choices. This month represents a turning point where financial wellness becomes a natural part of your lifestyle rather than a struggle.`,
      metrics: [
  ...
  const mockAlerts = [
    {
      ...
      message:
        "Congratulations! You've reached 75% of your emergency fund goal. Your financial security is getting stronger with each contribution.",
    ...
    },
    {
      ...
      message:
        "Your transportation spending is 15% over budget this month. Consider carpooling or using public transit to get back on track.",
    ...
    },
    {
      ...
      message:
        "You're ahead of schedule! Your vacation fund has reached $1,200, putting you 20% ahead of your timeline.",
      context: "Target: $2,000 by March 2025",
      progress: 60,
      timestamp: new Date(Date.now() - 3600000),
      actions: [{ label: "View Timeline", icon: "Calendar", primary: true }],
    },
  ];
        ...
        <div className="container mx-auto px-4 py-8 max-w-7xl">
          ...
          <div className="mb-8">
            ...
            <p className="text-muted-foreground text-lg">
              Your financial story continues to unfold beautifully. Here's
          ...
          <div className="bg-gradient-to-r from-primary/10 to-secondary/10 border border-primary/20 rounded-lg p-6 text-center">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Every dollar saved, every goal achieved, and every wise decision
              you make is writing a beautiful story of financial success. Keep
              going - your future self will thank you for the choices you're
              making today.
            </p>
          </div>
        </div>
