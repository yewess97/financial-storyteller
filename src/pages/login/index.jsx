            ...
            <div className="mb-8">
              ...
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Turn boring financial data into compelling narratives that
                  motivate and inspire. Track expenses, set goals, and watch
                  your financial story unfold with beautiful visualizations and
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-6">
          <div className="flex flex-col sm:flex-row items-center justify-between space-y-4 sm:space-y-0">
            <div className="flex items-center space-x-4 text-sm text-muted-foreground">
              <span>
                &copy; {new Date()?.getFullYear()} Financial Storyteller
              </span>
              <span>•</span>
