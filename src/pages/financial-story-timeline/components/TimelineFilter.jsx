      ...
      {isExpanded && (
        <div className="mt-4 pt-4 border-t border-border">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
            <Button
              variant={
                activeFilters?.amountRange === "small" ? "default" : "outline"
              }
              size="sm"
              onClick={() =>
                handleFilterChange(
            ...
            <Button
              variant={
                activeFilters?.amountRange === "medium" ? "default" : "outline"
              }
              size="sm"
              onClick={() =>
                handleFilterChange(
            ...
            <Button
              variant={
                activeFilters?.amountRange === "large" ? "default" : "outline"
              }
              size="sm"
              onClick={() =>
                handleFilterChange(
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          ...
          {Object.entries(activeFilters)?.map(([key, value]) => {
            ...
            const labelMap =
              ...
              (key === "showMilestones" ? "Milestones Only" : value);
