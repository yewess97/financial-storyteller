          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="text-lg font-bold text-warning">
                {formatCurrency(
                  stats?.totalTargetAmount - stats?.totalCurrentAmount
                )}
              </span>
            </div>
              ...
              <div className="flex items-start space-x-2">
                ...
                <p className="text-sm text-accent-foreground">
                  {stats?.averageProgress >= 75
                    ...
                    ? "You've made a start! Small steps lead to big achievements."
                    : "Every journey begins with a single step. Start building your financial future today!"}
                </p>
              </div>
            </div>
          </div>
