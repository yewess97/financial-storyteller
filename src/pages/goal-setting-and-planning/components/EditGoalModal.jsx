  ...
  const calculateMonthlyTarget = (targetAmount, targetDate, currentAmount) => {
    if (targetAmount && targetDate) {
      ...
      const monthsRemaining = Math.max(
        1,
        Math.ceil((target_date - now) / (1000 * 60 * 60 * 24 * 30))
      );
            ...
            <div className="flex items-start space-x-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  ...
                  cannot be undone and all progress data will be lost.
                </p>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <Input
                ...
                onChange={(e) =>
                  handleInputChange("currentAmount", e?.target?.value)
                }
                min="0"
                step="0.01"
              />
          ...
          <div className="space-y-4">
            ...
            <Input
              ...
              onChange={(e) =>
                handleInputChange("motivationMessage", e?.target?.value)
              }
