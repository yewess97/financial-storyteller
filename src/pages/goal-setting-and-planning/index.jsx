...
const GoalSettingAndPlanning = () => {
  ...
  const [user] = useState({
    ...
    avatar: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT-w-a96zAlaiKoPP_p9ekJ8yAG483wUvdniQ&s",
  ...
  const [goals, setGoals] = useState([
    {
      ...
      motivationMessage:
        "Peace of mind is priceless. This fund will protect my family from unexpected financial storms.",
      storyNarrative:
        "Building your financial safety net of $15,000 will give you peace of mind and security for unexpected life events.",
      milestones: [
    ...
    },
    {
      ...
      motivationMessage:
        "Life is short, and the world is wide. This trip will create memories that last a lifetime.",
      storyNarrative:
        "Your dream adventure awaits! Save $8,000 to create unforgettable memories and explore new horizons.",
      milestones: [
        { percentage: 25, description: "Great start!", achieved: true },
    ...
    },
    {
      ...
      monthlyTarget: 2375.0,
      motivationMessage:
        "Home is where love resides and memories are created. This investment is in our family's future.",
      storyNarrative:
        "Every dollar saved brings you closer to the keys of your dream home. Your future self will thank you for this $60,000 investment.",
      milestones: [
        { percentage: 25, description: "Great start!", achieved: true },
        { percentage: 50, description: "Halfway there!", achieved: false },
        { percentage: 75, description: "Almost done!", achieved: false },
    ...
    },
    {
      ...
      monthlyTarget: 4125.0,
      motivationMessage:
        "Education is the most powerful weapon to change the world and my career trajectory.",
      storyNarrative:
        "Investing in knowledge pays the best interest. Your $45,000 education goal is an investment in your future success.",
      milestones: [
        { percentage: 25, description: "Great start!", achieved: true },
        { percentage: 50, description: "Halfway there!", achieved: false },
        { percentage: 75, description: "Almost done!", achieved: false },
    ...
    },
    {
      ...
      monthlyTarget: 0,
      motivationMessage:
        "Reliable transportation means freedom and peace of mind for daily life.",
      storyNarrative:
        "Your reliable transportation solution is within reach. Save $25,000 for the vehicle that fits your lifestyle.",
      milestones: [
        { percentage: 25, description: "Great start!", achieved: true },
        { percentage: 50, description: "Halfway there!", achieved: true },
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
              <div>
                ...
                <p className="text-muted-foreground text-lg">
                  ...
                  with our storytelling approach
                </p>
              </div>
            ...
            <div className="mt-12 bg-gradient-to-r from-primary/10 to-secondary/10 rounded-lg p-8 text-center">
              <div className="max-w-2xl mx-auto">
                ...
                <p className="text-muted-foreground text-lg mb-6">
                  Every goal you set is a chapter in your financial success
                  story. Stay consistent, celebrate milestones, and watch your
